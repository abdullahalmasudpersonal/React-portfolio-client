    ...
    return (
        <div className='counter-bg'>
            <div className='container pt-5'>
                <h3 data-aos="flip-up" className='text-center pt-5 numbers-numbers-headline'>NUMBERS</h3>

                <div className="card-group pt-5 justify-content-center">
                    
                    <div data-aos="zoom-in-up" className="d-flex justify-content-center align-items-center">
                        <div className="" style={{padding:'60px 110px'}}>
                            ...
                            <h1 className='fw-bold text-center mt-3 mb-0'>0<CountUp end={2} /><span></span></h1>
                    ...
                    <div data-aos="zoom-in-up" className="d-flex justify-content-center align-items-center">
                        <div className="" style={{padding:'60px 110px'}}>
                            ...
                            <h1 className='fw-bold text-center mt-3 mb-0'>0<CountUp end={3} /><span></span></h1>
                    ...
                    <div data-aos="zoom-in-up" className="d-flex justify-content-center align-items-center">
                        <div className="" style={{padding:'60px 110px'}}>
                            ...
                            <h1 className='fw-bold text-center mt-3 mb-0'><CountUp end={10} /><span>+</span></h1>
